          ...
          <body style="margin: 0; padding: 0; background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
            <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
              ...
              <div style="margin-bottom: 30px;">
                ...
                <p style="color: #4b5563; margin: 0 0 24px 0; font-size: 16px; line-height: 1.6;">
                  At <strong style="color: #e84499;">OpenPools</strong>, we're building a new way to look at careers.<br>
                  Instead of judging people by titles or buzzwords, we look for <em style="color: #e84499;">signals</em>.<br>
                  The real patterns hidden in how someone works.
                </p>

                <p style="color: #4b5563; margin: 0 0 24px 0; font-size: 16px; line-height: 1.6;">
                  Those signals come together as a <em style="color: #e84499;">Professional DNA</em>.<br>
                  It's a short, visual read on your strengths, work style, and what you naturally gravitate toward.<br>
                  Most people find at least one thing they didn't expect.
                </p>

                <p style="color: #1f2937; margin: 0 0 24px 0; font-size: 16px; font-weight: 600; line-height: 1.6;">
                  Your DNA is ready to check out.<br>
                  No forms. No setup.
                </p>
                ...
                <div style="margin: 0 0 32px 0;">
                  <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td style="background-color: #e84499; border-radius: 6px;">
                        <a href="${inviteUrl}" target="_blank" style="display: inline-block; background-color: #e84499; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 500; font-size: 16px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">👉 See your Professional DNA</a>
                      </td>
                    </tr>
                  </table>
                </div>
                ...
                <p style="color: #6b7280; margin: 0 0 16px 0; font-size: 14px; line-height: 1.6;">
                  This invite is open for 30 days.<br>
                  Ignore if you're not curious.<br>
                  If you are, this is fun.
                </p>
