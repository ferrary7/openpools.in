 ...
 * Factors:
 * - Common keyword match (60%) - PRIMARY SIGNAL
...
export function calculateCompatibility(profile1Keywords, profile2Keywords, profile1 = {}, profile2 = {}) {
  ...
  // Factor 5: Collaboration style match (5% weight)
  const collaborationBonus = calculateCollaborationStyleBonus(profile1?.bio, profile2?.bio)
  const collaborationScore = (collaborationBonus / 10) * 5

  // Total compatibility score (0-100)
  const totalScore = keywordScore + diversityBonus + completenessScore + locationScore + collaborationScore
