...
export async function updateSession(request) {
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith('/api/dna') &&
    !request.nextUrl.pathname.startsWith('/api/dna-metrics') &&
    !request.nextUrl.pathname.startsWith('/api/showcase') &&
    !request.nextUrl.pathname.startsWith('/api/ai-insights') &&
    !request.nextUrl.pathname.startsWith('/api/invite/') &&
    !request.nextUrl.pathname.startsWith('/api/doppelganger') &&
    !request.nextUrl.pathname.startsWith('/invite/') &&
    !request.nextUrl.pathname.startsWith('/dna') &&
    !request.nextUrl.pathname.startsWith('/about') &&
    !request.nextUrl.pathname.startsWith('/doppelganger') &&
